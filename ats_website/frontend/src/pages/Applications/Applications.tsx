...
import { fetchApplications, deleteApplications } from '../../store/ApplicationSlice';
...
const Applications = () => {
    ...
    useEffect(() => {
        dispatch(fetchApplications({ pageIndex: 0, pageSize: 10 }));
    }, [dispatch]);
                            ...
                            >
                                ...
                                <div className="flex justify-between items-center pt-2 border-t border-gray-50 mt-2">
                                    ...
                                    <div className="flex gap-3" onClick={e => e.stopPropagation()}>
                                        <a href={c.resume_url} target="_blank" rel="noreferrer" className="text-blue-600 text-xs font-medium hover:underline">
                                            Resume
                                        </a>
                                        <button
